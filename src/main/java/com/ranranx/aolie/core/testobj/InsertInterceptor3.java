 ...
 **/
@Component
public class InsertInterceptor3 implements IOperInterceptor {
    Logger logger = LoggerFactory.getLogger(InsertInterceptor3.class);
    ...
    public boolean isCanHandle(String type, Object objExtinfo) {
        return type.equals(Constants.HandleType.TYPE_INSERT);
    }
    ...
    public HandleResult beforeOper(Object param) throws InvalidException {
        logger.error("--> Insert   " + getOrder() + ":beforeOper");
        return null;
    }
    ...
    public HandleResult afterOper(Object param, HandleResult result) {
        logger.error("--> Insert   " + getOrder() + ":afterOper");
        return null;
    }
    ...
    public HandleResult beforeReturn(Object param, HandleResult handleResult) {
        logger.error("--> Insert   " + getOrder() + ":beforeReturn");
        return null;
    }
