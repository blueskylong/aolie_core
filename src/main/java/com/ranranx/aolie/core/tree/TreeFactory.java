...
public class TreeFactory {
	...
	public static Node createTreeNode(Object id, String text, Object sortValue, Object value, int nodeHeight,
                                      Object attributes) {
		return new TreeNode(id, text, sortValue, value, nodeHeight, attributes);
	}
}